...
::: {.callout-warning}
During summer vacation - June 29 to August 9 - we train on Wednesday 18:00-20:00 at Nonnenweg 36.
:::
...
![](assets/SFHCS Logo.png){width=120%}
![](assets/LOGO_SWISSHEMA.png){style="floating margin=25ptx" width=120%}
...
::: {.content-visible when-profile="en"}
# Train Historical European Martial Arts in the heart of Basel
:::

::: {.content-visible when-profile="fr"}
# Pratiquez les arts martiaux historiques européens au cœur de Bâle
:::

::: {.content-visible when-profile="de"}
# Lerne Historisches Fechten im Herzen Basels
:::
...
::: {.img-float}
![](assets/SFHCS-Magglingen 26-097.jpg){style="center" width=100%}
:::
